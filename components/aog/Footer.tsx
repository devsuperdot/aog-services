      ...
      <div className="mx-auto max-w-[1600px] px-4 py-16 sm:px-6 md:px-12 md:py-20 lg:px-16 lg:py-24">
        <div className="grid gap-12 md:gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            <h3 className="mb-6 text-xs font-light uppercase tracking-[0.3em] text-white/70">
              Servicios
            </h3>
            <ul className="space-y-3">
              {services.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="group flex items-center gap-2 text-sm font-light text-white/50 transition-colors hover:text-white"
                  >
                    <ChevronRight className="h-3 w-3 text-aog-primary opacity-0 transition-all group-hover:translate-x-1 group-hover:opacity-100" />
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-sm">
                ...
                <div className="font-light text-white/50">{CONTACT_INFO.address.full}</div>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="relative mt-16 border-t border-white/5 pt-8 md:mt-20">
