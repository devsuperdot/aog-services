...
export const metadata = {
  title: 'Construcción | OTC Petroleum',
  description: 'Servicios integrales para la industria de la construcción',
}
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-header-text-secondary md:text-xl">
              Servicios integrales para la industria de la construcción
            </p>
          </div>
        </div>
      </section>
