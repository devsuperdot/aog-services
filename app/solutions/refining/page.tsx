...
import { Factory, Wrench, CheckCircle2, Settings, ArrowRight } from 'lucide-react'
  ...
  const services = [
    {
      ...
      description:
        'Mantenimiento preventivo y correctivo de equipos e infraestructura en plantas de refinación.',
      features: [
        'Mantenimiento programado 24/7',
    ...
    },
    {
      ...
      description:
        'Servicios de mecánica industrial especializada para equipos rotativos y estáticos en refinación.',
      features: [
    ...
    },
    {
      ...
      description:
        'Calibración, mantenimiento y reparación de sistemas de instrumentación y control de procesos.',
      features: [
    ...
    {
      icon: CheckCircle2,
      title: 'Gestión de Paradas de Planta',
      description:
        'Coordinación integral de paradas programadas (turnarounds) para mantenimiento mayor.',
      features: [
...
const BenefitsSection = () => {
  ...
  const benefits = [
    'Maximización de uptime y disponibilidad de planta',
    ...
    'Gestión eficiente de turnarounds',
  ]
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        >
          ...
          <h2 className="mb-6 overflow-hidden text-[clamp(2rem,5vw,4rem)] font-light leading-[1.1] tracking-tight text-white">
            {isInView && <CodeReveal text="Operación Continua" delay={0.2} />}
          </h2>
        </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-[1000px] px-4 text-center sm:px-6 md:px-12 lg:px-16">
        ...
        >
          <div className="mx-auto mb-8 inline-flex h-16 w-16 items-center justify-center border-2 border-aog-primary bg-white">
            <Factory className="h-8 w-8 text-aog-primary" strokeWidth={1.5} />
          </div>
          ...
          <p className="mx-auto mb-12 max-w-2xl font-light leading-relaxed text-black/60">
            Solicita información sobre nuestros servicios de mantenimiento industrial para plantas de
            refinación.
          </p>
