...
export const metadata = {
  title: 'Sector Industrial | OTC Petroleum',
  description: 'Inspecciones y certificaciones para el sector industrial',
}
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-header-text-secondary md:text-xl">
              Inspecciones y certificaciones para el sector industrial
            </p>
          </div>
        </div>
      </section>
