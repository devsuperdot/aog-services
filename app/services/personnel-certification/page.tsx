...
export const metadata = {
  title: 'Certificación de Personal | OTC Petroleum',
  description: 'Certificación de operadores y técnicos especializados',
}

export default function PersonnelCertificationPage() {
  return (
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-header-text-secondary md:text-xl">
              Certificación de operadores y técnicos especializados
            </p>
          </div>
        </div>
      </section>
