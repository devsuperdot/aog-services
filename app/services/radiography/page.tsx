...
export const metadata = {
  title: 'Radiografía Industrial | OTC Petroleum',
  description: 'Interpretación de imágenes radiográficas para control de calidad',
}
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-header-text-secondary md:text-xl">
              Interpretación de imágenes radiográficas para control de calidad
            </p>
          </div>
        </div>
      </section>
