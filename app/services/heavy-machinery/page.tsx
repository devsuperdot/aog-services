...
export const metadata = {
  title: 'Maquinaria Pesada | OTC Petroleum',
  description: 'Certificación de montacargas, plataformas y equipo pesado',
}
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 py-16 md:px-8 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-header-text-secondary md:text-xl">
              Certificación de montacargas, plataformas y equipo pesado
            </p>
          </div>
        </div>
      </section>
